...
const opportunities = [
  {
    ...
    description: 'Partner with TAWA to develop sustainable tourism accommodations within our managed areas.',
    benefits: ['Prime locations', 'Government support', 'Long-term leases', 'Marketing assistance'],
  },
  {
    icon: TrendingUp,
    title: 'Tour Operations',
    description: 'Licensed tour operator opportunities in TAWA-managed Game Reserves and Wildlife Management Areas.',
    benefits: ['Exclusive access', 'Training programs', 'Booking systems', 'Brand partnership'],
  },
  {
    icon: Leaf,
    title: 'Conservation Projects',
    description: 'Support critical conservation initiatives through funding, research partnerships, or technical assistance.',
    benefits: ['Tax incentives', 'Impact reporting', 'Recognition programs', 'Joint research'],
  },
  {
    icon: Users,
    title: 'Community Programs',
    description: 'Invest in community development projects that benefit local populations and wildlife conservation.',
    benefits: ['Social impact', 'Sustainable returns', 'Local partnerships', 'Government coordination'],
  },
];

const stats = [
  { value: '$50M+', label: 'Annual Tourism Revenue' },
  { value: '15,000+', label: 'Local Jobs Created' },
  { value: '170K+', label: 'km² Investment Area' },
        ...
        <div className="container-safari">
          ...
          >
            ...
            <div className="min-h-[4rem] md:min-h-[5rem] mb-6">
              <Typewriter
                text="Invest in Tanzania's Wildlife Future"
                speed={70}
                delay={200}
            ...
            <p className="text-muted-foreground text-lg">
              Partner with TAWA to develop sustainable tourism, support conservation efforts, 
              and create lasting impact for communities and wildlife.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-safari">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore diverse investment opportunities across tourism, conservation, and community development sectors.
            </p>
          </motion.div>
        ...
        <div className="container-safari text-center">
          ...
          >
            ...
            <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto">
              Connect with our investment team to discuss partnership opportunities 
              and learn more about investing in Tanzania's wildlife future.
            </p>
            <Link
              to="/contact"
