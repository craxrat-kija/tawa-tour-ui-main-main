        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-6 min-h-[3rem] md:min-h-[4rem]">
              <Typewriter
                text="Guardians of Tanzania's Wild Heritage"
                speed={70}
                delay={300}
            ...
            >
              The Tanzania Wildlife Management Authority (TAWA) is dedicated to the conservation, 
              management, and sustainable utilization of wildlife resources in Game Reserves, 
              Game Controlled Areas, and Wildlife Management Areas across Tanzania.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
