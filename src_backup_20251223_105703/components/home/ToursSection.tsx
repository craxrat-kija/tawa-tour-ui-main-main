  ...
  return (
    <section className="section-padding bg-gradient-to-b from-background via-muted/20 to-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-jungle-teal/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-jungle-yellow/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container-safari relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Experience the thrill of African wildlife with our carefully curated 
            safari packages across Tanzania's premier destinations.
          </p>
        </motion.div>
